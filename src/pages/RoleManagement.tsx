  ...
  if (!selectedPlant) {
    return (
      <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground">
        ...
        <p className="text-sm">Please select a Plant from the search bar above to view its roles.</p>
      </div>
    );
  }
    ...
    <div className="p-4 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-lg border">
        <div className="p-4 border-b">
          <h1 className="text-lg font-semibold text-gray-800">Existing Roles for {selectedPlant.plantName}</h1>
        </div>
              ...
              <Table>
                ...
                <TableBody>
                  {roles.length > 0 ? (
                      ...
                      <TableRow key={role._id}> 
                        <TableCell>
                          <Checkbox 
                            ...
                            onCheckedChange={(checked: boolean) => handleSelectRow(checked, role._id)}
                          />
                        </TableCell>
                    ...
                    <TableRow>
                      <TableCell colSpan={6} className="text-center h-24">No roles found for this plant.</TableCell>
                    </TableRow>
                  )}
                </TableBody>
              </Table>
