...
const submenuItems = {
  ...
  "RMS Settings": [
    ...
    { title: "Global RMS Mapping", icon: Globe,url: "/RMS-settings/global" },
    { title: "Global Add Model", icon: Globe,url: "/RMS-settings/add-model" },
    { title: "Plant RMS Mapping", icon: Building2,url: "/RMS-settings/plant" },
    { title: "Custom Plant Mapping Jobs", icon: Wrench,url: "/RMS-settings/custom-plant" },
    { title: "Custom Mapping", icon: Map,url: "/RMS-settings/custom" },
    { title: "Copy RMS Mapping To Prod", icon: Upload,url: "/RMS-settings/copy" },
    { title: "Scaling Factor Model", icon: BarChart3,url: "/RMS-settings/scaling" },
