...
const navigationItems = [
  ...
  { title: "Scada Settings", url: "/scada-settings", icon: Settings, hasSubmenu: false },
  ...
  { title: "Management", url: "/management", icon: Users, hasSubmenu: false },
  { title: "Warranty Management", url: "/warranty", icon: Shield, hasSubmenu: false },
  { title: "Platform Options", url: "/platform", icon: Sliders, hasSubmenu: false },
  { title: "Data Points", url: "/data-points", icon: Database, hasSubmenu: false },
  { title: "Equipment Audit", url: "/audit", icon: ClipboardCheck, hasSubmenu: false },
];
