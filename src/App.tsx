...
const App = () => (
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/" element={<LogIn />} />  {/*isse login file render ho rhi h*/}   
      <Route path="/Dashboard" element={<DashboardLayout />} />  {/*isse after sucessfull ye page dashboard ki render ho rhi h*/}  

      <Route path="/" element={<DashboardLayout />}> {/*yeha se dashboard layout ke andar chije hone wali h*/}
